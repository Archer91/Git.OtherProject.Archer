...
public class SqlSiteMapProvider : StaticSiteMapProvider
{
    ...
    private int _indexID, _indexTitle, _indexUrl, _indexDesc, _indexRoles, _indexParent, _indexTarget;
    ...
    private SiteMapNode CreateSiteMapNodeFromDataReader(DbDataReader reader)
    {
        ...
        SiteMapNode node = new SiteMapNode(this, id.ToString(), url, title, description, rolelist, targetAttribute, null, null);
